...
3. As administrator activate this module in Control Panel -> Modules -> Individual page -> Historic events.

## Usage
1. As user activate or deactivate the "Historic events" on the "Facts and events" tab as needed.
